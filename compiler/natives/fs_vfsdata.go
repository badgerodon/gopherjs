...
var FS = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2018, 2, 16, 23, 12, 25, 551710397, time.UTC),
		},
		"/src": &vfsgen۰DirInfo{
			name:    "src",
		...
		"/src/reflect": &vfsgen۰DirInfo{
			name:    "reflect",
			modTime: time.Date(2018, 2, 16, 23, 12, 25, 514523917, time.UTC),
		},
		...
		"/src/reflect/reflect.go": &vfsgen۰CompressedFileInfo{
			name:             "reflect.go",
			modTime:          time.Date(2018, 2, 16, 23, 12, 25, 515185589, time.UTC),
